...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead d-flex align-items-center">
            ...
            <form action="back/update.php?id=<?php echo $id ?>'" method="POST">
                <div class="form-group">
                    <label for="Name">Stock Name</label>
                    <input type="text" value="<?php echo $stock->Product_Name; ?>" class="form-control" name="NewName" id="Name" placeholder="Stock Name">
                </div>
                <div class="form-group">
                    <label for="Brand">Brand</label>
                    <input type="text" value="<?php echo $stock->Product_Brand; ?>" class="form-control" name="NewBrand" id="Brand" placeholder="Brand">
                </div>
                <div class="form-group">
                    <label for="Brand">Price</label>
                    <input type="text" value="<?php echo $stock->Product_Price; ?>" class="form-control" name="NewPrice" id="Price" placeholder="Price">
                </div>
                <div class="form-group">
                    <label for="Count">Product Count</label>
                    <input type="text" value="<?php echo $stock->Product_Quantity; ?>" class="form-control" name="NewCount" id="Count" placeholder="Count">
                </div> <br>
